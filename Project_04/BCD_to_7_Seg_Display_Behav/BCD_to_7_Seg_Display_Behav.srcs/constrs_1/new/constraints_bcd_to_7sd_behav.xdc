## Author: Juan Luna
## Project: BCD to 7-Segment Display Behavioral Model
...
set_property PACKAGE_PIN W7 [get_ports {segment[7]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {segment[7]}]
set_property PACKAGE_PIN W6 [get_ports {segment[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {segment[6]}]
set_property PACKAGE_PIN U8 [get_ports {segment[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {segment[5]}]
set_property PACKAGE_PIN V8 [get_ports {segment[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {segment[4]}]
set_property PACKAGE_PIN U5 [get_ports {segment[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {segment[3]}]
set_property PACKAGE_PIN V5 [get_ports {segment[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {segment[2]}]
set_property PACKAGE_PIN U7 [get_ports {segment[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {segment[1]}]

## Decimal point of 7-segment display
set_property PACKAGE_PIN V7 [get_ports segment[0]]							
