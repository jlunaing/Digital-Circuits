## Author: Juan Luna
## Project: BCD Comparator Structural Model
...
## Right side
set_property PACKAGE_PIN V17 [get_ports {B_bcd[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {B_bcd[0]}]
set_property PACKAGE_PIN V16 [get_ports {B_bcd[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {B_bcd[1]}]
set_property PACKAGE_PIN W16 [get_ports {B_bcd[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {B_bcd[2]}]
set_property PACKAGE_PIN W17 [get_ports {B_bcd[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {B_bcd[3]}]
...
set_property PACKAGE_PIN W2 [get_ports {A_bcd[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {A_bcd[0]}]
set_property PACKAGE_PIN U1 [get_ports {A_bcd[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {A_bcd[1]}]
set_property PACKAGE_PIN T1 [get_ports {A_bcd[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {A_bcd[2]}]
set_property PACKAGE_PIN R2 [get_ports {A_bcd[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {A_bcd[3]}]
